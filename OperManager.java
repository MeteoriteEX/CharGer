...
public class OperManager {
    ...
    private void makeMenus() {
        ...
        if ( Global.wordnetEnabled ) {
            ef.emgr.makeNewMenuItem( ef.operateMenu, charger.Global.strs( "AttachOntologyLabel" ), 0 );
            ...
            ef.emgr.makeNewMenuItem( ef.operateMenu, charger.Global.strs( "DeleteOntologyLabel" ), 0 );
    ...
    public void setMenuItems() {
        ...
        for ( int num = 0; num < ef.operateMenu.getItemCount(); num++ ) {
            ...
            if ( s.equals( MakeGenericCmdLabel ) ) {
                ...
                mi.setEnabled( ef.somethingHasBeenSelected );
            } else if ( s.equals( charger.Global.strs( "AttachOntologyLabel" ) ) ) {
                mi.setEnabled( ef.somethingHasBeenSelected );
            } else if ( s.equals( charger.Global.strs( "DeleteOntologyLabel" ) ) ) {
                mi.setEnabled( ef.somethingHasBeenSelected );
            }
        }
    ...
    * */
    ...
    public void performActionShowInternals( ArrayList objectList ) {
        ...
        while ( iter.hasNext() ) {
            GraphObject go = (GraphObject)iter.next();
            if ( go instanceof GNode ) {
                charger.Global.consoleMsg( go.toString() );
            }
        }
    }
     ...
     * @param g
     */
    public void performActionCommitToKB( charger.obj.Graph g ) {
    }
    ...
    public kb.matching.BinaryRelationMatchGroupMetrics matchMasterToOpenGraphs( EditFrame masterForMatch ) {
        ...
        while ( graphiter.hasNext() ) {
            ...
            if ( nextef != masterForMatch ) {
                charger.obj.Graph g = nextef.TheGraph;
