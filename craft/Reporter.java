...
public class Reporter {
    ...
    public static String getKnowledgeSummary() {
        ...
        all = kb.ConceptManager.getAll( new charger.obj.Graph() );
        iterall = all.iterator();
        while ( iterall.hasNext() ) {
            charger.obj.Graph g = (charger.obj.Graph)iterall.next();
            s.append( natLang( g, true ) );
        }

        all = kb.ConceptManager.getAll( new charger.obj.Relation() );
        iterall = all.iterator();
        while ( iterall.hasNext() ) {
            charger.obj.Relation r = (charger.obj.Relation)iterall.next();
            s.append( natLang( r, true ) );
        }

        all = kb.ConceptManager.getAll( new charger.obj.Actor() );
        iterall = all.iterator();
        while ( iterall.hasNext() ) {
            charger.obj.Actor a = (charger.obj.Actor)iterall.next();
            s.append( natLang( a, true ) );
        }

        all = kb.ConceptManager.getAll( new charger.obj.Concept() );
        iterall = all.iterator();
        while ( iterall.hasNext() ) {
            charger.obj.Concept c = (charger.obj.Concept)iterall.next();
            if ( !visited.contains( c ) ) {
                s.insert( 0, natLang( c, true ) );
            }
        }

        all = kb.ConceptManager.getAll( new charger.obj.TypeLabel() );
        iterall = all.iterator();
        while ( iterall.hasNext() ) {
            charger.obj.TypeLabel t = (charger.obj.TypeLabel)iterall.next();
    ...
    public static String natLang( charger.obj.Graph g, boolean includeDefinitions ) {
        ...
        //if ( !  type.equalsIgnoreCase( "Proposition" ) || ! ref.equals( "" ) ) 
        {
            ...
            while ( concepts.hasNext() ) {
                ...
                charger.obj.Concept c = (charger.obj.Concept)concepts.next();
                if ( !concepts.hasNext() ) {
                    s.append( " and " );
	 ...
	 */
	public static String natLang( charger.obj.Concept c, boolean includeDefinitions ) {
     ...
     * they have one
     */
    public static String natLang( charger.obj.TypeLabel t, boolean includeDefinitions ) {
     ...
     * they have one
     */
    public static String natLang( charger.obj.GNode r, boolean includeDefinitions ) {
