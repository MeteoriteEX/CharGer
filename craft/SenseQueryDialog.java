...
public class SenseQueryDialog extends JDialog {
    ...
    private Color bg = craft.Craft.craftPink;

    private charger.gloss.wn.WordnetManager wnmgr = null;
    ...
    private void setup() {
        ...
        label.setBackground( craft.Craft.craftPink );
        ...
        poschoices.setBackground( craft.Craft.craftPink );
...
//            label.setLocation( new Point( 0, 200 ) );
    ...
    private void performOK() {
        ...
        result = null;
        craft.Craft.say( "def is \"" + def.getText() + "\"; has " + def.getText().length() + " chars" );
        if ( def.getText().equals( "" ) ) {
            setGenericValues( "", "" );
            ...
            if ( wnmgr.wordExists( userword ) ) {
                SenseQueryDialog dialog = new craft.SenseQueryDialog(
