...
public class CraftWindow extends JFrame implements ManagedWindow {
     ...
     */
    public CraftWindow() {
        WindowManager.manageWindow( this, KeyStroke.getKeyStroke( KeyEvent.VK_1, charger.Global.AcceleratorKey ) );
        setupWindow();
        setVisible( true );
    }
...
//        conceptTable.sortByColumn( 0 );
    ...
    private void setupWindow() {
        setLocation( new Point( charger.Global.CharGerMasterFrame.getLocation().x,
                charger.Global.CharGerMasterFrame.getSize().height + charger.Global.CharGerMasterFrame.getLocation().y ) );
...
//        startGrid.setForeground( Color.white );
    ...
    private void setupSouthPanel() {
        ...
        sentenceLabel.setForeground( charger.Global.chargerBlueColor );
...
//        Global.pw.mainPane.setSelectedComponent( Global.pw.CraftPanel );
    ...
    public void performStartGrid() {
        ...
        if ( conceptOne.getOwnerFrame() != null ) {
            newname.append( charger.util.Util.stripFileExtension(
                    conceptOne.getOwnerFrame().graphAbsoluteFile.getAbsolutePath() ) );
        } else {
            newname.append( charger.util.Util.stripFileExtension( g.name ) );
        }
