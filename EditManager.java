...
//        ef.resetSelection();
    ...
    public void performActionDisplayAsXML() {
        ...
        ef.XMLDisplay.setTheText( charger.xml.CGXGenerator.generateXML( ef.TheGraph ) );
...
//                IOManager.saveGraph38XML( out, g );
    ...
    public EditorState currentState() {
        EditorState state = new EditorState( charger.xml.CGXGenerator.generateXML( ef.TheGraph ) );
...
//    }
    ...
    public void makeHoldGraph() {
        ...
        OperManager.performActionValidate( ef.TheGraph );
        ef.sp.repaint();
        holdGraph = charger.xml.CGXGenerator.generateXML( ef.TheGraph );
