...
public class BinaryRelationMatch
{
    ...
    private charger.obj.Graph _masterGraph = null;
    private charger.obj.Graph _toMatchGraph = null;
    ...
    */
     ...
     */
    public BinaryRelationMatch( charger.obj.Graph masterG, String masterName, charger.obj.Graph toMatchGraph, String toMatchName )
    {
        setupMaster( masterG );
    ...
    /**
        ...
        @param masterName a label for the master graph
     */
    public BinaryRelationMatch( charger.obj.Graph masterG, String masterName )
    {
        setupMaster( masterG );
        _masterName = masterName;
    }
    
    public void matchAGraph( charger.obj.Graph toMatchGraph, String toMatchName )
    {
        _toMatchName = toMatchName;
        _toMatchGraph = toMatchGraph;
    ...
    /**
        ...
        @see kb.ConceptManager#makeTableEntryArrayList(charger.obj.Concept, charger.obj.GNode, charger.obj.Concept, kb.ConceptManager.ConceptsToInclude) 
    */
    public void setupMaster( charger.obj.Graph masterG )
    {
   ...
   public  String convertTuplesToHTMLtable( ArrayList tuples, String summary )
     ...
     */
    public ArrayList<MatchedBinaryTuple> makeBinaryTuples( charger.obj.Graph masterG )
    {
                ...
                for ( int n1 = 0; n1 < edges.length; n1++ )
                    for ( int n2 = n1 + 1; n2 < edges.length; n2++ )
                    {
                        ...
                        if ( edges[ n1 ].howLinked( rel ) == GEdge.Direction.FROM ) 
                                c2 = (charger.obj.Concept)edges[ n1 ].toObj;
                        else 
                        ...
                        if ( edges[ n2 ].howLinked( rel ) == GEdge.Direction.FROM ) 
                                ...
                                c1 = (charger.obj.Concept)edges[ n2 ].fromObj;
        ...
        java.util.Collections.sort( tupleVector, new BinaryTuple.TupleComparator() );
        return tupleVector;
    }
