...
public class KnowledgeBase {
    ...
    private kb.hierarchy.TypeHierarchy conceptHierarchy;
    private kb.hierarchy.TypeHierarchy relationHierarchy;
     ...
     * @see TypeHierarchy#setTop(kb.hierarchy.TypeHierarchyNode) 
     * @see TypeHierarchy#setBottom(kb.hierarchy.TypeHierarchyNode)  
     */
