 ...
 * @author hsd
 */
public class GenericTextFrame extends javax.swing.JFrame implements ClipboardOwner, ManagedWindow {
    ...
    private void initComponents() {
        ...
        optionPlaceholderPanel = new javax.swing.JPanel();
        ...
        mainLabel.setFont(new java.awt.Font("Lucida Grande", 0, 14)); // NOI18N
...
//        theText.s( new Dimension(getContentPane().getWidth() - 2*margin, getContentPane().getHeight() - 10*margin));
    ...
    public javax.swing.JPanel optionPlaceholderPanel;
