...
/**
	...
	Implementers of this interface are allowed to write actor classes that "plug in" to CharGer 
	...
	"actorplugin". Responsibility for extracting referents from the charger.obj.Concept arguments lies with
